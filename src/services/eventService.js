...
class EventService {
  ...
  async createEvent(eventData) {
    try {
      ...
      const eventRecord = {
        ...
        nearby_event: eventData.nearbyEvent || null // Serp API search results
      };
  ...
  async updateEvent(eventId, updateData) {
    try {
      ...
      if (updateData.nearbyEvent !== undefined) updateFields.nearby_event = updateData.nearbyEvent;
  ...
  convertEventToCamelCase(event) {
    return {
      ...
      nearbyEvent: event.nearby_event,
